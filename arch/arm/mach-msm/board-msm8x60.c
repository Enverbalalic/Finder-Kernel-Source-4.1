...
int factory_mode = 0;
#endif
#ifdef CONFIG_VENDOR_EDIT//liuyan 2012.6.22
...
#ifdef CONFIG_VENDOR_EDIT//huqiao		
...
#endif
#if defined(CONFIG_VENDOR_EDIT)  //huqiao
...
#endif
//liuyan@MutimediaDrv.Headset begin
#ifdef CONFIG_VENDOR_EDIT
...
#endif
//liuyan@MutimediaDrv.Headset end
...
static struct persistent_ram msm_pr __initdata = {
	...
	.start = 0x7ff00000,//PLAT_PHYS_OFFSET + SZ_1G + SZ_512M,
	.size = SZ_1M,
};
#endif
...
/* OPPO 2012-10-10 wangjc Modify begin for set s1a to 0.55v */
#ifndef CONFIG_VENDOR_EDIT
static int usb_phy_susp_dig_vol = 750000;
#else
static int usb_phy_susp_dig_vol = 500000;
#endif
/* OPPO 2012-10-10 wangjc Modify end */
...
/* OPPO 2012-10-13 yxq modified begin for imx111 */
#ifndef CONFIG_VENDOR_EDIT
	.clk_freq = 100000,
#else
	.clk_freq = 300000,
#endif
/* OPPO 2012-10-13 yxq modified end */
	.src_clk_rate = 24000000,
	.msm_i2c_config_gpio = gsbi_qup_i2c_gpio_config,
};
...
/* OPPO 2012-10-13 yxq modified begin for s5k8aay */
#ifndef CONFIG_VENDOR_EDIT
	.clk_freq = 100000,
#else
	.clk_freq = 400000,
...
#define MSM_ION_MM_SIZE		0x4000000  /*0x3800000*/  /* (56MB) */
...
/* OPPO 2012-09-24 wangjc Modify begin for reason */
#ifndef CONFIG_VENDOR_EDIT
...
#endif
/* OPPO 2012-09-24 wangjc Modify end */
#ifdef CONFIG_VENDOR_EDIT
//huyu------------add
//static struct regulator *vreg_9[2], *vreg_11[2];//*vreg_10[2],
static struct regulator *vreg_9, *vreg_11;
//static int ipowon = 0;
...
int sensor_power_on(void)
{
	...
	if(vreg_9 == NULL)
	{
		vreg_9 = regulator_get(NULL, msm_VREG_L9A);
		if (IS_ERR(vreg_9)) {
			rc = PTR_ERR(vreg_9);
		...
		rc = regulator_set_voltage(vreg_9, 2800000, 2800000);
	...
	if(vreg_11 == NULL)
	{
		...
		vreg_11 = regulator_get(NULL, msm_VREG_L11A);
		if (IS_ERR(vreg_11)) {
			rc = PTR_ERR(vreg_11);
			printk( "%s: regulator_get %s = %d\n", __func__,
				msm_VREG_L11A, rc);
		...
		rc = regulator_set_voltage(vreg_11, 1800000, 1800000);
...
unget1:
	regulator_put(vreg_11);
	vreg_11 = NULL;
unget2:
	regulator_put(vreg_9);
	vreg_9 = NULL;
	return rc;
...
void sensor_power_enable(void)
{
	...
	if(vreg_9)
	{
		rc = regulator_enable(vreg_9);
		if (rc < 0) {
			printk(KERN_ERR"enable vreg_9  error!\n");
			return;
		}
	}
	if(vreg_11)
	{
		rc = regulator_enable(vreg_11);
		if (rc < 0) {
			printk(KERN_ERR"enable vreg_11  error!\n");
			return;
		}
	}
...
void sensor_power_disable(void)
{
	...
	if(vreg_9)
	{
		rc = regulator_disable(vreg_9);
		if (rc) {
			printk(KERN_ERR"disable vreg_9 error!\n");
		}
	}
	if(vreg_11)
	{
		rc = regulator_disable(vreg_11);
		if (rc) {
			printk(KERN_ERR"disable vreg_11 error!\n");
		}
	}
...
static void smb346_charger_ldo_power(int on)
{
	...
	if (IS_ERR_OR_NULL(vreg_ldo18_adc)) {
		pr_err("%s ldo18 error\n", __func__);
		return;
	}
...
/* OPPO 2012-10-12 yxq added begin for s5k8aay */
#ifdef CONFIG_VENDOR_EDIT
	REGULATOR_SUPPLY("cam_vdig",		"3-003c"),
#endif
/* OPPO 2012-10-12 yxq added end */
};
...
/* OPPO 2012-10-09 yxq added begin for imx111 */
#ifdef CONFIG_VENDOR_EDIT
	REGULATOR_SUPPLY("cam_vana",		"1-001a"),
	REGULATOR_SUPPLY("cam_vana",		"1-006c"),
	REGULATOR_SUPPLY("cam_vana",		"1-0078"),
	REGULATOR_SUPPLY("cam_vana",		"1-0010"),
#endif
/* OPPO 2012-10-09 yxq added end */
};
...
/* OPPO 2012-10-09 yxq deleted begin for imx111 */
#ifndef CONFIG_VENDOR_EDIT
	REGULATOR_SUPPLY("cam_vana",		"1-001a"),
	REGULATOR_SUPPLY("cam_vana",		"1-006c"),
	REGULATOR_SUPPLY("cam_vana",		"1-0078"),
#endif
/* OPPO 2012-10-09 yxq deleted end */
};
...
/* OPPO 2012-10-09 yxq added begin for imx111 */
#ifdef CONFIG_VENDOR_EDIT
	REGULATOR_SUPPLY("cam_vdig",		"1-0010"),
#endif
/* OPPO 2012-10-09 yxq added end */
};
...
/* OPPO 2012-10-09 yxq added begin for imx111 and led */
#ifdef CONFIG_VENDOR_EDIT
	REGULATOR_SUPPLY("cam_vio",			"1-0010"),
	REGULATOR_SUPPLY("cam_vio",			"1-0030"),
#endif
/* OPPO 2012-10-09 yxq added end */
};
...
/* OPPO 2012-10-12 yxq added begin for s5k8aay */
#ifdef CONFIG_VENDOR_EDIT
	REGULATOR_SUPPLY("cam_vana",		"3-003c"),
#endif
/* OPPO 2012-10-12 yxq added end */
};
...
/* OPPO 2012-10-12 yxq added begin for s5k8aay */
#ifdef CONFIG_VENDOR_EDIT
	REGULATOR_SUPPLY("cam_vio",		"3-003c"),
#endif
/* OPPO 2012-10-12 yxq added end */
};
...
/* OPPO 2012-10-10 yxq modified begin for imx111 */
#ifndef CONFIG_VENDOR_EDIT
	RPM_LDO(PM8058_L8,  0, 1, 0, 2900000, 3050000, LDO300HMIN),
#else
	RPM_LDO(PM8058_L8,  0, 1, 0, 2700000, 3050000, LDO300HMIN),
#endif
/* OPPO 2012-10-10 yxq modified end */
#ifndef CONFIG_VENDOR_EDIT
	RPM_LDO(PM8058_L9,  0, 1, 0, 1800000, 1800000, LDO300HMIN),
#else
	RPM_LDO(PM8058_L9,  0, 1, 0, 2800000, 2800000, LDO300HMIN),		//huyu
#endif
#ifndef CONFIG_VENDOR_EDIT                                                                      //liuyan
...
#endif
#ifdef CONFIG_VENDOR_EDIT //modifed by zhangyue on 2011-11-04
...
#ifdef CONFIG_I2C
/* OPPO 2012-09-26 wangjc Delete begin for del useless code. */
#ifndef CONFIG_VENDOR_EDIT
...
#endif
/* OPPO 2012-09-26 wangjc Delete end */
...
static void pmic8058_xoadc_mpp_config(void)
{
	...
	struct pm8xxx_mpp_init_info xoadc_mpps[] = {
		PM8058_MPP_INIT(XOADC_MPP_3, A_INPUT, PM8XXX_MPP_AIN_AMUX_CH5,
							AOUT_CTRL_DISABLE),
		#ifndef	CONFIG_VENDOR_EDIT  //modify by chendx 2011-09-26 for read vchg voltage					
		PM8058_MPP_INIT(XOADC_MPP_5, A_INPUT, PM8XXX_MPP_AIN_AMUX_CH9,
							AOUT_CTRL_DISABLE),
		#endif
		PM8058_MPP_INIT(XOADC_MPP_7, A_INPUT, PM8XXX_MPP_AIN_AMUX_CH6,
							AOUT_CTRL_DISABLE),
		#ifndef	CONFIG_VENDOR_EDIT  //modify by chendx 2011-09-26 make channel for checking vchg voltage
		//Todo
...
#if defined(CONFIG_VENDOR_EDIT) && defined(CONFIG_BATTERY_BQ27541_OPPO)//chendexiang ,20110218,add
...
/* OPPO 2012-09-12 wangjc Delete begin for reason */
#ifndef CONFIG_VENDOR_EDIT
...
#endif
/* OPPO 2012-09-12 wangjc Delete end */
...
static struct othc_accessory_info othc_accessories[]  = {
	...
	},
	{
        ...
        .enabled = true,
#else
		.enabled = false, //liuyan@MutimediaDrv.Headset
#endif
	},
	{
...
//qualcom riginal
#ifndef CONFIG_VENDOR_EDIT// liuyan modify 2012-3-13
...
#else
	.detection_delay_ms = 150,//1500, liuyan 2012.6.6,for quick plug headset
#endif
	/* Switch info */
#ifndef CONFIG_VENDOR_EDIT
    .switch_debounce_ms = 1500
#else
	.switch_debounce_ms = 1000,//1500,
#endif
...
#else
		hsed_config_1.othc_support_n_switch = false;  //liuyan@MutimediaDrv.Headset
...
#ifdef CONFIG_VENDOR_EDIT //Van modified 2012.05.07
...
static void __init register_i2c_devices(void)
{
	...
	u8 mach_mask = 0;
	int i;
/* OPPO 2012-10-10 yxq modified begin for imx111 and s5k8aay */
#ifndef CONFIG_VENDOR_EDIT
	...
	struct i2c_registry msm8x60_subcamera_i2c_device = {
		I2C_SURF | I2C_FFA | I2C_FLUID,
		MSM_GSBI8_QUP_I2C_BUS_ID,
		msm8x60_subcamera_board_info.board_info,
		msm8x60_subcamera_board_info.num_i2c_board_info,
	};
...
/* OPPO 2012-10-10 yxq modified begin for imx111 and s5k8aay*/
	...
	if (msm8x60_camera_i2c_devices.machs & mach_mask)
		i2c_register_board_info(msm8x60_camera_i2c_devices.bus,
			msm8x60_camera_i2c_devices.info,
			msm8x60_camera_i2c_devices.len);
	if (msm8x60_subcamera_i2c_device.machs & mach_mask)
		i2c_register_board_info(msm8x60_subcamera_i2c_device.bus,
			msm8x60_subcamera_i2c_device.info,
			msm8x60_subcamera_i2c_device.len);
#endif
/* OPPO 2012-10-10 yxq modified end */
#endif
}
...
/* OPPO 2012-10-09 wangjc Delete begin for del useless code. */
#ifndef CONFIG_VENDOR_EDIT
...
#endif
/* OPPO 2012-10-09 wangjc Delete end */
...
static struct mmc_platform_data msm8x60_sdc4_data = {
	...
	.mmc_bus_width  = MMC_CAP_4_BIT_DATA,
#ifdef CONFIG_VENDOR_EDIT
/*For Broadcom wifi SDIO detect purpose*/
...
/* OPPO 2012-10-08 wangjc Delete begin for del useless code. */
#ifndef CONFIG_VENDOR_EDIT
...
#endif
/* OPPO 2012-10-08 wangjc Delete end */
...
/*OPPO hewei add begin for restart is crashing 2012-05-23*/
	.cont_splash_enabled = 0x01,
/*OPPO hewei add end for restart is crashing 2012-05-23*/
