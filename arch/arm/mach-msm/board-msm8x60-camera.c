...
#include "devices.h"
/* OPPO 2012-10-09 yxq added begin for led */
...
/* OPPO 2012-10-09 yxq modified begin for imx111's voltage */
#ifndef CONFIG_VENDOR_EDIT
	{"cam_vana", REG_LDO, 2850000, 2850000, -1},
#else
	{"cam_vana", REG_LDO, 2700000, 2700000, -1},
#endif
/* OPPO 2012-10-09 yxq modified end */
	{"cam_vio", REG_VS, 0, 0, 0},
	{"cam_vdig", REG_LDO, 1200000, 1200000, -1},
};

static struct gpio msm8x60_common_cam_gpio[] = {
/* OPPO 2012-10-09 yxq deleted begin for reason */
#ifndef CONFIG_VENDOR_EDIT
...
/* OPPO 2012-10-09 yxq modified begin for imx111 */
#ifndef CONFIG_VENDOR_EDIT
...
#else
	{106, GPIOF_OUT_INIT_LOW, 10000},
	{106, GPIOF_OUT_INIT_HIGH, 10000},
#endif
/* OPPO 2012-10-09 yxq modified end */
};
...
static struct gpio s5k8aay_cam_gpio[] = {
	{30, GPIOF_DIR_IN, "SUBCAM_MCLK"},
	{45, GPIOF_DIR_OUT, "SUBCAM_PWD"},
	{72, GPIOF_DIR_OUT, "SUBCAM_RST"},
	{64, GPIOF_DIR_IN, "CAM2_I2C_DATA"},
	{65, GPIOF_DIR_IN, "CAM2_I2C_CLK"},
};

static struct msm_gpio_set_tbl s5k8aay_cam_gpio_set_tbl[] = {
	{45, GPIOF_OUT_INIT_LOW, 5000},
	{45, GPIOF_OUT_INIT_HIGH, 5000},
	{72, GPIOF_OUT_INIT_LOW, 5000},
	{72, GPIOF_OUT_INIT_HIGH, 5000},
};

static struct msm_camera_gpio_conf s5k8aay_cam_gpio_conf = {
	.cam_gpio_common_tbl = msm8x60_common_cam_gpio,
	.cam_gpio_common_tbl_size = ARRAY_SIZE(msm8x60_common_cam_gpio),
	.cam_gpio_req_tbl = s5k8aay_cam_gpio,
	.cam_gpio_req_tbl_size = ARRAY_SIZE(s5k8aay_cam_gpio),
	.cam_gpio_set_tbl = s5k8aay_cam_gpio_set_tbl,
	.cam_gpio_set_tbl_size = ARRAY_SIZE(s5k8aay_cam_gpio_set_tbl),
};
...
static struct msm_camera_sensor_platform_info sensor_board_info_s5k8aay = {
	...
	.gpio_conf = &s5k8aay_cam_gpio_conf,
};
...
static struct i2c_board_info msm8x60_subcamera_i2c_boardinfo[] = {
	{
...
struct msm_camera_board_info msm8x60_subcamera_board_info = {
	.board_info = msm8x60_subcamera_i2c_boardinfo,
	.num_i2c_board_info = ARRAY_SIZE(msm8x60_subcamera_i2c_boardinfo),
};
#endif
...
/* OPPO 2012-10-09 yxq added begin for main camera and led  */
#ifdef CONFIG_VENDOR_EDIT
	{
