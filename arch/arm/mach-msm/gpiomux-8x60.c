...
/* OPPO 2012-10-09 wangjc Delete begin for del sdcc2 gpio config. */
...
/* OPPO 2012-10-09 wangjc Delete begin for del sdcc5 gpio config. */
#ifndef CONFIG_VENDOR_EDIT
...
/* OPPO 2012-10-11 yxq modified begin for sub camera's MCLK */
#ifndef CONFIG_VENDOR_EDIT
	/* Qualcomm Release */
	.func = GPIOMUX_FUNC_1,
	.drv = GPIOMUX_DRV_2MA,
	...
	.pull = GPIOMUX_PULL_DOWN,
#endif
/* OPPO 2012-10-11 yxq modified end */
};
...
/* OPPO 2012-10-13 yxq added begin for flash */
#ifdef CONFIG_VENDOR_EDIT
...
//huangtongfeng del 2012.4.13	
#ifdef CONFIG_VENDOR_EDIT	
	{
		...
		.settings = {
			...
			[GPIOMUX_ACTIVE]    = &spi_suspended_cs_config,
		},
	},
	{
		.gpio      = 36,
		.settings = {
			[GPIOMUX_SUSPENDED] = &spi_suspended_config,
			[GPIOMUX_ACTIVE]    = &spi_suspended_config,
		},
	},
#endif	
...
static struct msm_gpiomux_config msm8x60_ebi2_configs[] __initdata = {
	...
	#endif
/* OPPO 2012-10-13 yxq modified begin for flash's gpio */
#ifndef CONFIG_VENDOR_EDIT
	{
		.gpio      = 125,
		.settings = {
...
static struct msm_gpiomux_config msm8x60_charm_sdc_configs[] __initdata = {
	/* SDCC5 cmd */
	{
		.gpio = 95,
		.settings = {
			[GPIOMUX_ACTIVE]    = &sdcc5_suspend_config,
...
/* OPPO 2012-10-13 yxq added begin for s5k8aay */
#ifdef CONFIG_VENDOR_EDIT
