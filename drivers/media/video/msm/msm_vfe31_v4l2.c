...
/* OPPO 2012-12-25 leihui Add begin for reason */
        vfe31_ctrl->update_rolloff = 1;
/* OPPO 2012-12-25 leihui Add end */
		break;
...
/* OPPO 2012-12-25 leihui Add begin for reason */
    if(vfe31_ctrl->update_rolloff == 1 && vfe31_ctrl->operation_mode != VFE_OUTPUTS_THUMB_AND_MAIN &&
		vfe31_ctrl->operation_mode != VFE_OUTPUTS_MAIN_AND_THUMB &&
		vfe31_ctrl->operation_mode != VFE_OUTPUTS_THUMB_AND_JPEG &&
		vfe31_ctrl->operation_mode != VFE_OUTPUTS_JPEG_AND_THUMB )
    {
        vfe31_ctrl->update_rolloff = 0;
        return;
    }
/* OPPO 2012-12-25 leihui Add end */
